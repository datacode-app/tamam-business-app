...
// Project imports:
import 'package:tamam_business/common/widgets/code_picker_widget.dart';
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            label: widget.showLabelText ? Text.rich(TextSpan(children: [
              ...
              TextSpan(text: widget.labelText ?? '', style: robotoRegular.copyWith(fontSize: widget.labelTextSize ?? Dimensions.fontSizeLarge, color: Theme.of(context).hintColor.withAlpha((.75 * 255).round()))),
            ...
            ) : widget.prefixImage == null && widget.prefixIcon != null ? Icon(widget.prefixIcon, size: widget.iconSize, color: Theme.of(context).disabledColor.withAlpha((0.4 * 255).round())) : null,
            suffixIcon: widget.isPassword ? IconButton(
              icon: Icon(_obscureText ? Icons.visibility_off : Icons.visibility, color: Theme.of(context).hintColor.withAlpha((0.3 * 255).round())),
              onPressed: _toggle,
            ) : widget.suffixChild,
          ),
