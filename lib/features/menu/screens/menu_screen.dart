...
import 'package:tamam_business/features/menu/domain/models/menu_model.dart';
import 'package:tamam_business/features/menu/widgets/menu_button_widget.dart';
...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // if(Get.find<StoreController>().isSelfDeliveryEnabled && 
    //    Get.find<ProfileController>().profileModel!.stores![0].module!.moduleType != 'rental' &&
    ...
    // 🚨 APPLE COMPLIANCE: Only show "My Business Plan" if remote config allows business plan view
    if (RemoteConfigHelper.isBusinessPlanViewEnabled()) {
