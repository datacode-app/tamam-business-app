...
import 'package:tamam_business/features/subscription/domain/models/check_product_limit_model.dart';
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      child: Stack(children: [
                        ...
                        ClipRRect(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              border: Border.all(color: Theme.of(context).disabledColor.withAlpha((0.1 * 255).round())),
                            ),
                          ),
                        ),
                        ...
                        Positioned(
                          ...
                          child: Column(children: [
                            ...
                            Divider(color: Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()), indent: 40, endIndent: 40, thickness: 1),
                    ...
                    isRenew ? Stack(children: [
                      ...
                      Positioned(
                        ...
                        child: Column(children: [
                          ...
                          Divider(color: Colors.white.withAlpha((0.2 * 255).round()), indent: 40, endIndent: 40, thickness: 1),
                          ...
                          Text('${package.validity} ' 'days'.tr, style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.white.withAlpha((0.8 * 255).round()))),
                          const SizedBox(height: Dimensions.paddingSizeDefault),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    margin: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault),
                    decoration: BoxDecoration(
                      color: subscriptionController.isSelect && subscriptionController.paymentIndex == 0 ? Theme.of(context).primaryColor.withAlpha((0.05 * 255).round()) : Theme.of(context).cardColor,
                      borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                      border: Border.all(color: subscriptionController.isSelect && subscriptionController.paymentIndex == 0 ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withAlpha((0.2 * 255).round())),
                    ),
                    child:  Row(children: [
                      Container(
                        height: 20, width: 20,
                ...
                Get.find<SplashController>().configModel!.digitalPayment! ? GridView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return InkWell(
                      ...
                      child: Container(
                        decoration: BoxDecoration(
                          color: isSelected ? Theme.of(context).primaryColor.withAlpha((0.05 * 255).round()) : Theme.of(context).cardColor,
                          borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                          border: Border.all(color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withAlpha((0.2 * 255).round())),
                        ),
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Expanded(
                ...
                child: CustomButtonWidget(
                  ...
                  color: Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()),
                  textColor: Theme.of(context).textTheme.bodyLarge!.color?.withAlpha((0.8 * 255).round()),
                ),
              ),
              const SizedBox(width: Dimensions.paddingSizeDefault),
