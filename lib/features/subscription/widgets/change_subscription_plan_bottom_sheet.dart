      ...
      return  subscriptionController.packageList != null ? Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Text(
            ...
            style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color?.withAlpha((0.5 * 255).round())),
          ),
          const SizedBox(height: Dimensions.paddingSizeDefault),
                   ...
                   Positioned(
                     ...
                     child: Padding(
                       ...
                       child: !subscriptionController.isLoading ? CustomButtonWidget(
                         color: subscriptionController.activeSubscriptionIndex == index ? Colors.deepOrangeAccent.withAlpha((0.9 * 255).round()) : Colors.cyan.shade700,
