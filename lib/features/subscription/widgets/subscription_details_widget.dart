...
import 'package:tamam_business/features/subscription/widgets/billing_info_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Container(
        ...
        child: Column(children: [
          // Check remote config before showing business plan changes
          if (RemoteConfigHelper.isBusinessPlanChangesEnabled())
            CustomButtonWidget(
            ...
            // Show blocked feature message when disabled
            Container(
              padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
              child: Column(
                children: [
                  ...
                  const SizedBox(height: Dimensions.paddingSizeSmall),
                  Text(
                    'change_business_plan_not_available'.tr,
                    style: robotoMedium.copyWith(
