...
import 'package:tamam_business/features/payment/widgets/payment_method_bottom_sheet_widget.dart';
import 'package:tamam_business/features/payment/widgets/wallet_attention_alert_widget.dart';
import 'package:tamam_business/features/payment/widgets/wallet_widget.dart';
import 'package:tamam_business/features/payment/widgets/withdraw_request_bottom_sheet_widget.dart';
                        ...
                        Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          (profileController.profileModel!.cashInHands != 0 && profileController.profileModel!.balance! < profileController.profileModel!.cashInHands!) ? InkWell(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                                color: profileController.profileModel!.showPayNowButton! ? Theme.of(context).cardColor : Theme.of(context).disabledColor.withAlpha((0.8 * 255).round()),
                              ),
