...
import 'package:tamam_business/helper/url_validator.dart';
                      ...
                      child: Column(children: [
                        ...
                        Align(
                          ...
                          child: Text(
                            ...
                            style: robotoRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor.withAlpha((0.5 * 255).round())),
                          ),
                        ),
