...
import 'package:tamam_business/features/rental_module/trips/widgets/shimmer/trip_list_shimmer.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/taxi_order_button_widget.dart';
    ...
    _scrollController.addListener(() {
      if (_scrollController.position.pixels == _scrollController.position.maxScrollExtent) {
        if (!tripController.isLoading && tripController.tripsList != null) {
          ...
          tripController.getTripList(status: tripController.selectedStatus!, offset: nextPage.toString());
        }
      }
    });
                ...
                Expanded(
                  child: Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text(
                        'today'.tr,
                        style: robotoRegular.copyWith(color: Theme.of(context).cardColor.withAlpha((0.7 * 255).round())),
                      ),
