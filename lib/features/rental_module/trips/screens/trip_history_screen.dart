              ...
              return profileController.profileModel != null ? Container(
                ...
                child: Column(children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: Theme.of(context).textTheme.bodyLarge!.color?.withAlpha((0.1 * 255).round()),
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                    ...
                    Container(height: 35, width: 0.5, color: Theme.of(context).cardColor.withAlpha((0.5 * 255).round())),
