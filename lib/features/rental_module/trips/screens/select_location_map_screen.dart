...
import 'package:tamam_business/features/address/widgets/permission_dialog_widget.dart';
...
import 'package:tamam_business/features/rental_module/trips/widgets/location/address_input_field.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/location/animated_map_icon_extended.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/location/animated_map_icon_minimized.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/location/custom_floating_action_button.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/location/custom_icon_layout.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/location/custom_vertical_dotted_line.dart';
      ...
      return Scaffold(
        ...
        body: Stack(children: [
          ...
          Positioned(
            ...
            child: Container(
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                boxShadow: [BoxShadow(color: Theme.of(context).disabledColor.withAlpha((0.3 * 255).round()), spreadRadius: 2, blurRadius: 4, offset: const Offset(0, 2))],
              ),
            ...
            child: Column(children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(shape: BoxShape.circle,
                  boxShadow: [BoxShadow(color: Colors.black.withAlpha((0.2 * 255).round()), blurRadius: 6, spreadRadius: 0.5, offset: const Offset(0, 4))],
                ),
          ...
          Positioned(
            ...
            child: Container(
              decoration: BoxDecoration(
                boxShadow: [BoxShadow(color: Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()), blurRadius: 10)],
                color: Theme.of(context).cardColor,
              ),
