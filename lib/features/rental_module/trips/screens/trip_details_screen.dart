...
import 'package:tamam_business/features/rental_module/common/widgets/custom_slider_button.dart';
...
import 'package:tamam_business/features/rental_module/trips/domain/models/trip_details_model.dart';
import 'package:tamam_business/features/rental_module/trips/screens/edit_trip_details_screen.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/assign_driver_widget.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/bill_title_amount_widget.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/confirm_payment_bottom_sheet.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/select_driver_widget.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/select_vehicle_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TripController>(builder: (tripController) {
      ...
      if (tripDetails != null) {
        for (int i = 0; i < tripDetails.tripDetails!.length; i++) {
          tripAmount =
              (tripAmount! + tripDetails.tripDetails![i].calculatedPrice!);
        }
      }
      double? discountOnTrip =
          tripDetails != null ? tripDetails.discountOnTrip : 0;
      double? couponDiscountAmount =
          tripDetails != null ? tripDetails.couponDiscountAmount : 0;
      double? referralDiscount =
          tripDetails != null ? tripDetails.refBonusAmount : 0;
      double? subTotal = tripAmount! -
          (discountOnTrip! + couponDiscountAmount! + referralDiscount!);
      double? vatAmount = tripDetails != null ? tripDetails.taxAmount : 0;
      double? serviceFee =
          tripDetails != null ? tripDetails.additionalCharge : 0;
      double? totalAmount = tripDetails != null ? tripDetails.tripAmount : 0;
      double? partiallyPaidAmount =
          tripDetails != null ? tripDetails.partiallyPaidAmount : 0;
      double? duePayment = totalAmount! - partiallyPaidAmount!;

      bool pending = tripDetails != null && tripDetails.tripStatus == 'pending';
      bool confirmed =
          tripDetails != null && tripDetails.tripStatus == 'confirmed';
      bool ongoing = tripDetails != null && tripDetails.tripStatus == 'ongoing';
      bool completed =
          tripDetails != null && tripDetails.tripStatus == 'completed';
      bool canceled =
          tripDetails != null && tripDetails.tripStatus == 'canceled';
      bool paymentFailed =
          tripDetails != null && tripDetails.tripStatus == 'payment_failed';
      bool isPaid = tripDetails != null && tripDetails.paymentStatus == 'paid';
      bool partialPayment =
          tripDetails != null && tripDetails.paymentMethod == 'partial_payment';
      bool taxIncluded =
          tripDetails != null && tripDetails.taxStatus == 'included';
        ...
        child: Scaffold(
          ...
          appBar: AppBar(
            title: Column(children: [
              ...
              Text(
                tripDetails != null
                    ? tripDetails.tripStatus?.tr ?? ''
                    : widget.tripStatus?.tr ?? '',
                style: robotoMedium.copyWith(
                    fontSize: Dimensions.fontSizeLarge,
          ...
          body: RefreshIndicator(
            ...
            child: tripDetails != null
                ? Column(children: [
                      ...
                      child: SingleChildScrollView(
                        child: Column(children: [
                                ...
                                children: [
                                  ...
                                  Row(
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: tripDetails.isGuest!
                                              ? Column(
                                                  crossAxisAlignment:
                                                      CrossAxisAlignment.start,
                                                  children: [
                                                      Text(
                                                          tripDetails.userInfo
                                                                  ?.contactPersonName ??
                                                              '',
                                                          style: robotoMedium),
                                                      const SizedBox(
                                              ...
                                              : Column(
                                                  ...
                                                  children: [
                                                      Text(
                                                          '${tripDetails.customer?.fName ?? ''} ${tripDetails.customer?.lName ?? ''}',
                                                          style: robotoMedium),
                                                      const SizedBox(
                                                          height: Dimensions
                                                              .paddingSizeSmall),
                                        ...
                                        (!completed &&
                                            ...
                                            ? tripDetails.isGuest!
                                                ...
                                                : InkWell(
                                                    onTap: () async {
                                                      if (Get.find<TaxiProfileController>()
                                                                  .profileModel!
                                                                  .subscription !=
                                                              null &&
                                                          Get.find<TaxiProfileController>()
                                                                  .profileModel!
                                                                  .subscription!
                                                                  .chat ==
                                                              0 &&
                                          ...
                                          onTap: () async {
                                            if (tripDetails.isGuest!) {
                                              if (await canLaunchUrlString(
                                                  'tel:${tripDetails.userInfo?.contactPersonNumber ?? ''}')) {
                                                launchUrlString(
                                                    'tel:${tripDetails.userInfo?.contactPersonNumber ?? ''}',
                                                    mode: LaunchMode
                                                        .externalApplication);
                                                ...
                                                showCustomSnackBar(
                                                    '${'can_not_launch'.tr} ${tripDetails.userInfo?.contactPersonNumber ?? ''}');
                                              }
                                            } else {
                                              if (await canLaunchUrlString(
                                                  'tel:${tripDetails.customer?.phone ?? ''}')) {
                                                launchUrlString(
                                                    'tel:${tripDetails.customer?.phone ?? ''}',
                                                    mode: LaunchMode
                                                        .externalApplication);
                                                ...
                                                showCustomSnackBar(
                                                    '${'can_not_launch'.tr} ${tripDetails.customer?.phone ?? ''}');
                                              }
                                            }
                                          },
                                  ...
                                  children: [
                                    ...
                                    !isVehicleDeleted
                                        ? pending
                                            ? InkWell(
                                                onTap: () {
                                                  Get.to(() => EditTripDetailsScreen(
                                                      tripDetails: tripController
                                                          .tripDetailsModel!));
                                                },
                                                child: Row(children: [
                                                  CustomAssetImageWidget(
                                                      Images.editIconOutlined,
                                                      height: 20,
                                                      width: 20,
                                  ...
                                  Expanded(
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            DateConverter.dayDateTime(
                                                tripDetails.scheduleAt!),
                                            style: robotoRegular.copyWith(
                                                fontSize:
                                                    Dimensions.fontSizeSmall,
                                                color: Theme.of(context)
                                  ...
                                  Expanded(
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            '${tripDetails.tripType?.tr} (${tripDetails.tripType == 'hourly' ? '${'estimated'.tr} ${tripDetails.estimatedHours?.toStringAsFixed(2)}hr' : '${'estimated'.tr} ${tripDetails.distance?.toStringAsFixed(2)}km'})',
                                            style: robotoRegular.copyWith(
                                                fontSize:
                                                    Dimensions.fontSizeSmall,
                                                color: Theme.of(context)
                          ...
                          tripDetails.tripNote != null
                              ...
                              : const SizedBox(),
                          SizedBox(
                              height: tripDetails.tripNote != null
                                  ? Dimensions.paddingSizeSmall
                                  : 0),
                          const SelectVehicleWidget(),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          tripDetails.vehicleIdentity != null &&
                                  tripDetails.vehicleIdentity!.isNotEmpty &&
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  BillTitleAmountWidget(
                                    title: 'trip_cost'.tr,
                                    amount: tripAmount,
                                    isEditAmount: tripController
                                            .tripDetailsModel?.edited ==
                                        1,
                                  ),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
                                  BillTitleAmountWidget(
                                      title: 'trip_discount'.tr,
                                      amount: discountOnTrip,
                                      isSubtract: true),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
                                  BillTitleAmountWidget(
                                  ...
                                  BillTitleAmountWidget(
                                      title:
                                          '${'subtotal'.tr} ${taxIncluded ? '(${'vat_included'.tr})' : ''}',
                                      amount: subTotal),
                                  const SizedBox(
                                      height: Dimensions.paddingSizeSmall),
                                  taxIncluded
                                      ...
                                      : BillTitleAmountWidget(
                                          title:
                                              '${'vat'.tr} (${tripDetails.taxPercentage}%)'
                                                  .tr,
                                          amount: vatAmount!,
                                          isAdd: true),
                                  SizedBox(
                    ...
                    (completed && isPaid) || canceled || paymentFailed
                        ? const SizedBox()
                        : Container(
                            padding: const EdgeInsets.all(
                                Dimensions.paddingSizeDefault),
                            ...
                            child: pending
                                ? Row(children: [
                                    ...
                                    Expanded(
                                      child: CustomButtonWidget(
                                        isLoading:
                                            tripController.isStatusLoading,
                                        onPressed: () {
