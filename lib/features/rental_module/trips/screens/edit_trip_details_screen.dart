...
import 'package:tamam_business/features/rental_module/provider/widgets/trip_type_card.dart';
...
import 'package:tamam_business/features/rental_module/trips/screens/select_location_map_screen.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/time/date_time_picker_sheet.dart';
...
class _EditTripDetailsScreenState extends State<EditTripDetailsScreen> {
  ...
  void initState() {
    ...
    tripController.setTempAddress(
        addressModel: widget.tripDetails.pickupLocation!, isFrom: true);
    tripController.setTempAddress(
        addressModel: widget.tripDetails.destinationLocation!, isFrom: false);
    tripController.setFromAddress(widget.tripDetails.pickupLocation!,
        willUpdate: false);
    tripController.setToAddress(widget.tripDetails.destinationLocation!,
        willUpdate: false);
  }
            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                  ...
                  children: [
                    ClipRRect(
                      ...
                      child: SizedBox(
                        ...
                        child: GoogleMap(
                          ...
                          polylines:
                              Set<Polyline>.of(tripController.polyLines.values),
                          zoomControlsEnabled: false,
                          style: null, // Default map style
                          initialCameraPosition: CameraPosition(
                            target: LatLng(
                              tripController.fromAddress?.lat ??
                                  tripController.tempFromAddress!.lat!,
                              tripController.fromAddress?.lng ??
                                  tripController.tempFromAddress!.lng!,
                            ),
                            zoom: 16,
                          ),
                            ...
                            tripController.setFromToMarker(
                              ...
                              from: LatLng(
                                  ...
                                  tripController.fromAddress?.lng ??
                                      tripController.tempFromAddress!.lng!),
                              to: LatLng(
                                  tripController.toAddress?.lat ??
                                      tripController.tempToAddress!.lat!,
                                  tripController.toAddress?.lng ??
                                      tripController.tempToAddress!.lng!),
                            );
                          },
                        ),
                      ),
                          ...
                          Column(children: [
                            ...
                            Column(
                              children: List.generate(4, (index) {
                                return Container(
                                  margin:
                                      EdgeInsets.only(top: index == 0 ? 0 : 5),
                                  color: Theme.of(context)
                                      .disabledColor
                      ...
                      child: Row(children: [
                                ...
                                Text(
                                  tripController.finalTripDateTime != null
                                      ? DateConverter.isSameDate(
                                              tripController.finalTripDateTime!)
                                          ? 'pickup_now'.tr
                                          : 'custom'.tr
                                      : 'pick_time'.tr,
                                  style: robotoMedium.copyWith(
                                  ...
                                  tripController.finalTripDateTime != null
                                      ? DateConverter.utcToDateTime(
                                          DateConverter.formatDate(
                                              tripController
                                                  .finalTripDateTime!))
                                      : widget.tripDetails.scheduleAt != null
                                          ? DateConverter.utcToDateTime(
                                              widget.tripDetails.scheduleAt!)
                                          : 'not_set_yet'.tr,
                                  style: robotoRegular.copyWith(
                                      fontSize: Dimensions.fontSizeSmall,
                                      color: Theme.of(context).disabledColor),
                        ...
                        InkWell(
                          onTap: () {
                            Get.bottomSheet(
                              DateTimePickerSheet(
                                  scheduleAt: widget.tripDetails.scheduleAt!),
                              backgroundColor: Colors.transparent,
                              isScrollControlled: true,
                            );
                          },
                          child: CustomAssetImageWidget(Images.editIconOutlined,
                              height: 20,
                              width: 20,
                              color: Theme.of(context).primaryColor),
                        ),
                    ...
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    Row(children: [
                      widget.tripDetails.tripType == 'hourly'
                          ? Expanded(
                              child: TripTypeCard(
                              tripType: 'hourly'.tr,
                              amount: 0,
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Row(
                                    ...
                                    children: [
                                      Text('*${'system_est_fair'.tr}: ',
                                          style: robotoRegular),
                                      Text(
                                        PriceConverterHelper.convertPrice(
                                            tripController
                                                .systemEstimatedFairCalculation(
                                                    index)),
                                        style: robotoRegular.copyWith(
                                            color: Theme.of(context)
                                                .textTheme
                                        ...
                                        onChanged: (value) {
                                          if (value.isNotEmpty) {
                                            if (tripController
                                                    ...
                                                    .vehicle!
                                                    .totalVehicleCount! >=
                                                int.parse(tripController
                                                    .quantityControllers[index]
                                                    .text)) {
                                              tripController
                                                  .calculateTripFair(index);
                                            } else {
                                              showCustomSnackBar(
                                                  '${"you_can_not_add_more_than".tr} ${tripController.tripDetailsModel!.tripDetails![index].vehicle!.totalVehicleCount} ${'vehicles'.tr}');
                                              tripController
                                                  .resetCalculateTripFair(
                                                      index);
                                            }
                                          }
                                        },
                ...
                child: Container(
                  ...
                  child: CustomButtonWidget(
                    ...
                    textColor: Theme.of(context)
                        ...
                        ?.withAlpha((0.6 * 255).round()),
                    color:
                        Theme.of(context).disabledColor.withAlpha((0.1 * 255).round()),
                  ),
                ),
              ),
              const SizedBox(width: Dimensions.paddingSizeSmall),
                ...
                child: CustomButtonWidget(
                  ...
                  onPressed: () {
                    if (tripController.quantityControllers
                      ...
                      tripController.editTripDetails(
                          tripId: widget.tripDetails.id!);
                    }
                  },
