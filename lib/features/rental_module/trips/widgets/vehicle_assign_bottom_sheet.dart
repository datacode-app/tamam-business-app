        ...
        return providerController.vehicleDetailsModel != null ? Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Row(children: [
                      Text('${'category'.tr}:', style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),
                    ...
                    Row(children: [
                      Text('${'brand'.tr}:', style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),
                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Theme.of(context).disabledColor.withAlpha((0.07 * 255).round()),
              ),
              child: Row(children: [

                Text('sl'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),
                const SizedBox(width: Dimensions.paddingSizeDefault),

                Expanded(
                  child: Text('identity_number'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),
                ),
                const SizedBox(width: Dimensions.paddingSizeDefault),

                Text('action'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: Container(
                    height: 43,
                    decoration: BoxDecoration(
                      border: Border.all(color: Theme.of(context).disabledColor.withAlpha((0.5 * 255).round())),
                      borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                    ),
                    child: CustomButtonWidget(
                      ...
                      textColor: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.6 * 255).round()),
