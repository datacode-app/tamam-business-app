...
class _BillTitleAmountWidgetState extends State<BillTitleAmountWidget> {
  ...
  Widget build(BuildContext context) {
    return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
      Row(children: [
        Text(widget.title, style: widget.isBoldText ? robotoBold : robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withAlpha((0.7 * 255).round()))),
        SizedBox(width: widget.isInfo ? Dimensions.paddingSizeExtraSmall : 0),

        widget.isInfo ? CustomToolTip(message: 'This is the amount of the bill', child: Icon(Icons.info_outline, size: 15, color: Theme.of(context).textTheme.bodyLarge!.color?.withAlpha((0.7 * 255).round()))) : const SizedBox(),
      ]),
      ...
      Row(children: [
        ...
        Text(
          ...
          style: widget.isBoldText ? robotoBold : robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withAlpha((0.7 * 255).round())),
        ),
      ]),
    ]);
  }
