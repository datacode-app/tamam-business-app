...
import 'package:tamam_business/features/rental_module/trips/widgets/overflow_container_widget.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/vehicle_assign_bottom_sheet.dart';
              ...
              Expanded(child: Stack(children: [
                ...
                listLength > 3 ? Positioned(
                  ...
                  child: Container(height: 55, width: 55,
                    ...
                    decoration:  BoxDecoration(color: Colors.black.withAlpha((0.2 * 255).round()), borderRadius: BorderRadius.circular(Dimensions.radiusDefault),),
                    ...
                    Row(children: [
                      ...
                      Expanded(
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(children: [
                            Text('${'quantity'.tr}:', style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),
