...
import 'package:tamam_business/features/rental_module/trips/widgets/time/custom_time_picker.dart';
...
class _DateTimePickerSheetState extends State<DateTimePickerSheet> {
  ...
  void initState() {
    ...
    selectTripDate = widget.scheduleAt != null
        ? DateTime.parse(widget.scheduleAt!)
        : tripController.selectedTripDate;
    selectTripTime = widget.scheduleAt != null
        ? DateTime.parse(widget.scheduleAt!)
        : tripController.selectedTripTime;
  }
            ...
            child: SfDateRangePicker(
                ...
                onSelectionChanged: (DateRangePickerSelectionChangedArgs args) {
                  ...
                  if (args.value is DateTime) {
                    ...
                    selectedDate = DateTime.parse(args.value as String);
                  } else {
                ...
                selectableDayPredicate: (DateTime val) {
                  return val.isAfter(DateTime(DateTime.now().year,
                ...
                CustomButtonWidget(
                  ...
                  onPressed: canUpdate
                      ? () {
                          ...
                          DateTime date = DateConverter.formattingTripDateTime(
                              tripController.selectedTripTime!,
                              tripController.selectedTripDate!);
                          ...
                          if (DateConverter.isAfterCurrentDateTime(date)) {
                            ...
                            showCustomSnackBar(
                                'you_cannot_select_before_current_time'.tr);
                          }
                          date = date;
                        }
                      : null,
