                      ...
                      Row(children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Row(children: [
                              Text('${'license'.tr}:', style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.5 * 255).round()))),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                              Flexible(child: Text(widget.vehicleIdentity?[index].vehicleIdentityData?.licensePlateNumber ?? 'N/A', style: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.6 * 255).round())), maxLines: 1, overflow: TextOverflow.ellipsis)),
                            ]),
                          ]),
                        ),
