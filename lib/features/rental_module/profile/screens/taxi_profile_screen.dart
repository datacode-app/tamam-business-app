...
import 'package:tamam_business/features/profile/widgets/notification_status_change_bottom_sheet.dart';
import 'package:tamam_business/features/profile/widgets/profile_bg_widget.dart';
import 'package:tamam_business/features/profile/widgets/profile_card_widget.dart';
import 'package:tamam_business/features/rental_module/profile/controllers/taxi_profile_controller.dart';
import 'package:tamam_business/features/rental_module/profile/screens/taxi_update_profile_screen.dart';
        ...
        return taxiProfileController.profileModel == null ? const Center(child: CircularProgressIndicator()) : ProfileBgWidget(
          ...
          mainWidget: SingleChildScrollView(physics: const BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              // Dark mode toggle hidden as per user request
