...
class TaxiProfileModel {
  ...
  TaxiProfileModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    fName = json['f_name'];
    lName = json['l_name'];
    phone = json['phone'];
...
class Store {
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    if (json['pickup_zone_id'] != null) {
      pickupZoneId = json['pickup_zone_id'].cast<String>();
    }
    if (json['translations'] != null) {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (pickupZoneId != null) {
      data['pickup_zone_id'] = json.encode(pickupZoneId);
    }
    if (translations != null) {
      data['translations'] = translations!.map((v) => v.toJson()).toList();
    }
