...
import 'package:tamam_business/common/widgets/paginated_list_widget.dart';
...
import 'package:tamam_business/features/rental_module/chat/widgets/message_bubble_widget.dart';
...
class TaxiChatScreen extends StatefulWidget {
  ...
  const TaxiChatScreen({super.key, required this.notificationBody, this.user, this.conversationId, this.fromNotification = false});
...
class _TaxiChatScreenState extends State<TaxiChatScreen> {
  ...
  void initState() {
    ...
    Get.find<TaxiChatController>().getMessages(1, widget.notificationBody!, widget.user, widget.conversationId, firstLoad: true);

  }

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TaxiChatController>(builder: (chatController) {
            ...
            child: Center(
              child: SizedBox(
                ...
                child: Column(children: [
                  ...
                  GetBuilder<TaxiChatController>(builder: (chatController) {
                  ...
                  /*(chatController.messageModel != null && (chatController.messageModel!.status! || chatController.messageModel!.messages!.isEmpty)) ?  */Container(
                    ...
                    child: Column(children: [
                      ...
                      Row(children: [
                        ...
                        InkWell(
                          onTap: () async {
                            Get.find<TaxiChatController>().pickImage(false);
                          },
                          child: Padding(
                        ...
                        Expanded(
                          child: TextField(
                            ...
                            onSubmitted: (String newText) {
                              if(newText.trim().isNotEmpty && !Get.find<TaxiChatController>().isSendButtonActive) {
                                Get.find<TaxiChatController>().toggleSendButtonActivity();
                              }else if(newText.isEmpty && Get.find<TaxiChatController>().isSendButtonActive) {
                                Get.find<TaxiChatController>().toggleSendButtonActivity();
                              }
                            },
