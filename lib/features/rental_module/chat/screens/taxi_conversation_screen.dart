...
class TaxiConversationScreen extends StatefulWidget {
  const TaxiConversationScreen({super.key});

  @override
  State<TaxiConversationScreen> createState() => _TaxiConversationScreenState();
}

class _TaxiConversationScreenState extends State<TaxiConversationScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TaxiChatController>(builder: (chatController) {
      TaxiConversationsModel? conversation0;
