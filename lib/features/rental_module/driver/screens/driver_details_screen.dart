...
import 'package:tamam_business/features/rental_module/common/widgets/custom_switch_button.dart';
...
import 'package:tamam_business/features/rental_module/driver/screens/add_driver_screen.dart';
import 'package:tamam_business/features/rental_module/driver/widgets/driver_delete_bottom_sheet.dart';
import 'package:tamam_business/features/rental_module/driver/widgets/status_wise_order_button_widget.dart';
import 'package:tamam_business/features/rental_module/trips/controllers/trip_controller.dart';
import 'package:tamam_business/features/rental_module/trips/domain/models/status_list_model.dart';
...
import 'package:tamam_business/features/rental_module/trips/widgets/order_count_widget.dart';
import 'package:tamam_business/features/rental_module/trips/widgets/taxi_order_widget.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TripController>(builder: (tripController) {
      return GetBuilder<DriverController>(builder: (driverController) {
        ...
        return Scaffold(
          appBar: AppBar(
            backgroundColor: Theme.of(context).primaryColor.withAlpha((0.95 * 255).round()),
              ...
              PopupMenuButton(
                ...
                icon: Container(
                  ...
                  decoration: BoxDecoration(
                    color: Theme.of(context).cardColor.withAlpha((0.1 * 255).round()),
                ...
                child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Text(widget.driver?.phone ?? '', style: robotoRegular.copyWith(color: Theme.of(context).cardColor.withAlpha((0.7 * 255).round()))),

                      Text(widget.driver?.email ?? '', style: robotoRegular.copyWith(color: Theme.of(context).cardColor.withAlpha((0.7 * 255).round()))),
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    Container(height: 35, width: 0.5, color: Theme.of(context).disabledColor.withAlpha((0.4 * 255).round())),
