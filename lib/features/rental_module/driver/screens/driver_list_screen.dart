...
import 'package:tamam_business/features/rental_module/driver/screens/driver_details_screen.dart';
import 'package:tamam_business/features/rental_module/driver/widgets/driver_delete_bottom_sheet.dart';
import 'package:tamam_business/features/rental_module/driver/widgets/shimmer/driver_list_shimmer.dart';
        ...
        return driverController.driversList != null ? driverController.driversList!.isNotEmpty ? Column(children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [BoxShadow(color: Colors.grey.withAlpha((0.2 * 255).round()), spreadRadius: 1, blurRadius: 5, offset: const Offset(0, 1))],
            ),
                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Expanded(
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Text(driverController.driversList?[index].phone ?? '', style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withAlpha((0.7 * 255).round()))),
