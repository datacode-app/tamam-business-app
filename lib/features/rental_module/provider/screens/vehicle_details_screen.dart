...
import 'package:tamam_business/features/rental_module/provider/widgets/vehicle_delete_bottom_sheet.dart';
import 'package:tamam_business/features/rental_module/provider/widgets/vehicle_grid_item.dart';
                  ...
                  children: List.generate(providerController.vehicleDetailsModel!.imagesFullUrl!.length, (index) {
                    return Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        color: providerController.currentVehicleImageIndex == index ? Theme.of(context).primaryColor : Theme.of(context).primaryColor.withAlpha((0.2 * 255).round()),
                      ),
                    );
                  }),
                ),
