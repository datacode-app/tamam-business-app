              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          ...
                          child: DottedBorder(
                            ...
                            strokeWidth: 1,
                            color: Get.isDarkMode ? Colors.white.withAlpha((0.2 * 255).round()) : const Color(0xFFE5E5E5),
                            child: _vehicle!.thumbnailFullUrl != null || providerController.vehicleThumbnail != null ? const SizedBox() : Container(
                              ...
                              decoration: BoxDecoration(
                                color: Get.isDarkMode ? Colors.white.withAlpha((0.05 * 255).round()) : const Color(0xFFFAFAFA),
                                borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                              ),
                              child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                RichText(
                                  ...
                                  text: TextSpan(children: [
                                    ...
                                    const TextSpan(text: '\n'),
                                    TextSpan(text: 'or_drag_and_drop'.tr, style: robotoBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),
                                  ]),
                                ),
                ...
                Container(
                  ...
                  child: Column(children: [
                        ...
                        child: Row(children: [
                          ...
                          Expanded(
                            child: Row(children: [
                              ...
                              Text('hourly'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
                          ...
                          Expanded(
                            child: Row(children: [
                              ...
                              Text('distance_wise'.tr, style: robotoRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color)),
                    ...
                    SizedBox(height: providerController.isTripTypeHourly || providerController.isTripTypeDistanceWise ? Dimensions.paddingSizeLarge : 0),
                    ...
                    providerController.isTripTypeHourly || providerController.isTripTypeDistanceWise ? Container(
                      decoration: BoxDecoration(
                        border: Border.all(color: Theme.of(context).disabledColor.withAlpha((0.2 * 255).round())),
                        borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                      ),
                    ...
                    return Container(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          Text(
                            '${'vehicle'.tr} ${index + 1}',
                            style: robotoBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.5 * 255).round())),
                          ),
                ...
                providerController.isSameModelMultipleVehicle ? InkWell(
                  ...
                  child: Container(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text('add_new'.tr, style: robotoBold.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.6 * 255).round()))),
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index){
                          return Container(
                            ...
                            decoration: BoxDecoration(color: Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()), borderRadius: BorderRadius.circular(Dimensions.radiusSmall)),
                            child: Center(child: Row(children: [
                              Text(providerController.tagList[index]!, style: robotoRegular.copyWith(color: Theme.of(context).disabledColor.withAlpha((0.7 * 255).round()))),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                              InkWell(onTap: () => providerController.removeTag(index), child: Icon(Icons.clear, size: 18, color: Theme.of(context).disabledColor.withAlpha((0.7 * 255).round()))),
                            ])),
                          );
                        },
                      ),
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              ...
                                              style: robotoBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round())),
                                            ),
                                          ],
                                        ),
                                      ),
            ...
            child: Row(children: [
              ...
              Expanded(
                child: Container(
                  height: 43,
                  decoration: BoxDecoration(
                    border: _update ? null : Border.all(color: Theme.of(context).disabledColor.withAlpha((0.5 * 255).round())),
                  ...
                  child: CustomButtonWidget(
                    ...
                    textColor: _update ? Theme.of(context).colorScheme.error : Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.6 * 255).round()),
                    color: _update ? Theme.of(context).colorScheme.error.withAlpha((0.1 * 255).round()) : Theme.of(context).disabledColor.withAlpha((0.1 * 255).round()),
                  ),
                ),
              ),
              const SizedBox(width: Dimensions.paddingSizeSmall),
