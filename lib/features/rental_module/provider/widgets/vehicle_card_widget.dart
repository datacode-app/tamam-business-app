        ...
        child: Column(children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            double.parse(vehicle?.avgRating ?? '0') > 0 ? Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.star_rounded, color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.6 * 255).round()), size: 20),
                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                  Text(
                    double.parse(vehicle?.avgRating ?? '0').toStringAsFixed(1),
                    style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.6 * 255).round())),
                  ),
                ],
              ),
            ) : const SizedBox(),
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                vehicle!.discountPrice != 0 ? Text(
                  ...
                  style: robotoRegular.copyWith(
                    ...
                    decorationColor: Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.6 * 255).round()),
                  ),
                ) : const SizedBox(),
                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
