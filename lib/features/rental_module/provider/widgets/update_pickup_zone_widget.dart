...
class UpdatePickupZoneWidget extends StatelessWidget {
  final List<String> pickupZoneList;
  const UpdatePickupZoneWidget({super.key, required this.pickupZoneList});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<AddressController>(builder: (addressController) {

      if (addressController.zoneList != null && addressController.pickupZoneList.isEmpty) {
        addressController.preloadPickupZones(pickupZoneList: pickupZoneList);
      }
