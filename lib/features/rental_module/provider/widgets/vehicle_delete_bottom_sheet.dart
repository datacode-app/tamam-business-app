...
class VehicleDeleteBottomSheet extends StatelessWidget {
  final int vehicleId;
  final bool fromDetails;
  const VehicleDeleteBottomSheet({super.key, required this.vehicleId, this.fromDetails = false});
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(
            ...
            child: Column(children: [
              const CustomAssetImageWidget(Images.warning, height: 50, width: 50),
              ...
              Padding(
                ...
                child: Text(
                  'vehicle_delete_confirmation'.tr,
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Expanded(
                  child: CustomButtonWidget(
                    ...
                    onPressed: () {
                      providerController.deleteVehicle(vehicleId: vehicleId, fromDetails: true);
                    },
                    buttonText: 'yes'.tr,
                  ),
                ),
