...
import 'package:tamam_business/features/rental_module/coupon/screens/taxi_add_coupon_screen.dart';
...
class TaxiCouponCardDialogueWidget extends StatelessWidget {
  final Coupons couponBody;
  final int index;
  const TaxiCouponCardDialogueWidget({super.key, required this.couponBody, required this.index});
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(image: const AssetImage(Images.couponDetails), fit: BoxFit.fitWidth,
                  colorFilter: Get.isDarkMode ? ColorFilter.mode(Colors.black.withAlpha((0.2 * 255).round()), BlendMode.dstATop) : null,
              ),
            ),
            child: Stack(
              children: [
                ...
                Align(
                  ...
                  child: GetBuilder<TaxiCouponController>(builder: (taxiCouponController) {
                      ...
                      OutlinedButton(
                        ...
                        onPressed: (){
                          ...
                          Get.dialog(ConfirmationDialogWidget(
                            ...
                            onYesPressed: () {
                              taxiCouponController.deleteCoupon(couponBody.id);
                            },
