...
class TaxiAddCouponScreen extends StatefulWidget {
  final Coupons? coupon;
  const TaxiAddCouponScreen({super.key, this.coupon});

  @override
  State<TaxiAddCouponScreen> createState() => _TaxiAddCouponScreenState();
}

class _TaxiAddCouponScreenState extends State<TaxiAddCouponScreen> {
  ...
  void initState() {
    ...
    if (widget.coupon != null) {
      ...
      Get.find<TaxiCouponController>().setCouponTypeIndex(
          widget.coupon!.couponType == 'default' ? 0 : 1, false);
      Get.find<TaxiCouponController>().setDiscountTypeIndex(
  ...
  Widget build(BuildContext context) {
    ...
    if (Get.find<ProfileController>().profileModel != null &&
        Get.find<ProfileController>().profileModel!.stores != null) {
    ...
    if (!selfDelivery) {
      Get.find<TaxiCouponController>().setCouponTypeIndex(0, false);
    }
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child:
            GetBuilder<TaxiCouponController>(builder: (taxiCouponController) {
          return Column(children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: DropdownButton<String>(
                                value: taxiCouponController.couponTypeIndex == 0
                                    ? 'default'
                                    : 'free_delivery',
                                ...
                                onChanged: (value) {
                                  taxiCouponController.setCouponTypeIndex(
            ...
            const SizedBox(height: Dimensions.paddingSizeLarge),
            taxiCouponController.couponTypeIndex == 0
                ? Row(children: [
                    Expanded(
                        child: TextFieldWidget(
                    ...
                    Expanded(
                        child: Column(
                          ...
                          Container(
                            ...
                            child: DropdownButton<String>(
                              value: taxiCouponController.discountTypeIndex == 0
                                  ? 'percent'
                                  : 'amount',
                              ...
                              onChanged: (value) {
                                taxiCouponController.setDiscountTypeIndex(
                ...
                : const SizedBox(),
            SizedBox(
                height: taxiCouponController.couponTypeIndex == 0
                    ? Dimensions.paddingSizeLarge
                    : 0),
            taxiCouponController.couponTypeIndex == 0 &&
                    taxiCouponController.discountTypeIndex == 0
                ? TextFieldWidget(
            ...
            !taxiCouponController.isLoading
                ? CustomButtonWidget(
                    ...
                    onPressed: () {
                      ...
                      if (defaultNameNull) {
                      ...
                      } else if (taxiCouponController.couponTypeIndex == 0 &&
                          discount.isEmpty) {
                        showCustomSnackBar(
                        ...
                        if (widget.coupon == null) {
                          taxiCouponController.addCoupon(
                          ...
                          taxiCouponController.updateCoupon(
