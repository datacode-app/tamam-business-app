...
import 'package:tamam_business/features/rental_module/review/screens/taxi_review_reply_screen.dart';
      ...
      child: Column(children: [
        Container(
          ...
          child:
            ...
            Text(DateConverter.utcToDateTime(review.createdAt!),
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            Get.find<SplashController>().configModel!.storeReviewReply ?? false
                ? CustomButtonWidget(
                    onPressed: () {
                      Get.to(() => TaxiReviewReplyScreen(
                          isGiveReply: review.reply != null ? false : true,
                          review: review,
                          providerReviewReplyStatus:
