...
import 'package:tamam_business/features/rental_module/banner/screens/taxi_banner_list_screen.dart';
import 'package:tamam_business/features/rental_module/brand/screens/taxi_brand_screen.dart';
import 'package:tamam_business/features/rental_module/category/screens/taxi_category_screen.dart';
import 'package:tamam_business/features/rental_module/chat/screens/taxi_conversation_screen.dart';
import 'package:tamam_business/features/rental_module/coupon/screens/taxi_coupon_screen.dart';
import 'package:tamam_business/features/rental_module/driver/screens/driver_list_screen.dart';
import 'package:tamam_business/features/rental_module/expense/screens/expense_screen.dart';
import 'package:tamam_business/features/rental_module/menu/domain/models/taxi_menu_model.dart';
import 'package:tamam_business/features/rental_module/menu/widgets/taxi_menu_button_widget.dart';
import 'package:tamam_business/features/rental_module/profile/controllers/taxi_profile_controller.dart';
import 'package:tamam_business/features/rental_module/profile/screens/taxi_profile_screen.dart';
import 'package:tamam_business/features/rental_module/provider/screens/add_vehicle_screen.dart';
import 'package:tamam_business/features/rental_module/review/screens/taxi_customer_review_screen.dart';
import 'package:tamam_business/features/subscription/screens/my_subscription_screen.dart';
import 'package:tamam_business/helper/responsive_helper.dart';
...
class TaxiMenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if(Get.find<TaxiProfileController>().taxiModulePermission!.rentalReport!) {
      menuList.add(TaxiMenuModel(icon: Images.expense, title: 'report'.tr, route: const ExpenseScreen()));
    }
