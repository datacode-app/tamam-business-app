                  ...
                  return GetBuilder<BannerController>(builder: (bannerController) {
                    return GetBuilder<TripController>(builder: (tripController) {
                        return GetBuilder<AuthController>(builder: (authController) {
                          ...
                          || dmController.isLoading || authController.isLoading || bannerController.isLoading || tripController.isCancelLoading) ? const Center(child: CircularProgressIndicator()) : Row(children: [
