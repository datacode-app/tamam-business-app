...
import 'package:tamam_business/features/addon/widgets/add_addon_bottom_sheet_widget.dart';
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Container(
                ...
                color: index % 2 == 0 ? Theme.of(context).cardColor : Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()),
                child: Row(children: [
