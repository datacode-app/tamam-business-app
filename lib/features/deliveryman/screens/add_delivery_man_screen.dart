...
class _AddDeliveryManScreenState extends State<AddDeliveryManScreen> {
  ...
  void initState() {
    ...
    if (_update) {
      ...
      Get.find<DeliveryManController>().setIdentityTypeIndex(
        Get.find<DeliveryManController>().identityTypeList[0],
        false,
      );
      Get.find<DeliveryManController>().setIdentityTypeIndex(
        Get.find<DeliveryManController>().identityTypeList[0],
  ...
  void _splitPhone(String? phone) async {
    try {
      ...
      _phoneController.text = phoneNumber.international.substring(
                          ...
                          children: [
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: DropdownButton<String>(
                                          value:
                                              dmController
                                                  .identityTypeList[dmController
                                                  .identityTypeIndex],
                                          items:
                                              dmController.identityTypeList.map(
                                                (String value) {
                            ...
                            SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                physics: const BouncingScrollPhysics(),
                                itemCount:
                                    dmController.pickedIdentities.length + 1,
                                itemBuilder: (context, index) {
                                  XFile? file =
                                      index ==
                                              dmController
                                  ...
                                  if (index ==
                                      dmController.pickedIdentities.length) {
                                    return InkWell(
                                      onTap: () {
                                        if (dmController
                                                .pickedIdentities
