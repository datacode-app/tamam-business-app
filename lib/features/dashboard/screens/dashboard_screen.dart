...
import 'package:tamam_business/features/dashboard/widgets/bottom_nav_item_widget.dart';
import 'package:tamam_business/features/dashboard/widgets/out_of_stock_warning_bottom_sheet.dart';
import 'package:tamam_business/features/disbursement/helper/disbursement_helper.dart';
import 'package:tamam_business/features/home/screens/home_screen.dart';
import 'package:tamam_business/features/menu/screens/menu_screen.dart';
import 'package:tamam_business/features/order/screens/order_history_screen.dart';
...
import 'package:tamam_business/features/rental_module/home/screens/taxi_home_screen.dart';
import 'package:tamam_business/features/rental_module/menu/screens/taxi_menu_screen.dart';
import 'package:tamam_business/features/rental_module/provider/screens/provider_screen.dart';
import 'package:tamam_business/features/rental_module/trips/screens/trip_history_screen.dart';
...
class DashboardScreenState extends State<DashboardScreen> {
  ...
  showDisbursementWarningMessage() async {
    try {
      await disbursementHelper.enableDisbursementWarningMessage(true);
    } catch (e) {
      debugPrint('Error showing disbursement warning: $e');
    }
  }
        ...
        floatingActionButton: !GetPlatform.isMobile || keyboardVisible
            ...
            : Container(
                decoration: BoxDecoration(
                  border:
                      Border.all(color: Theme.of(context).cardColor, width: 5),
