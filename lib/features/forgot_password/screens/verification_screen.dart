            ...
            Padding(
              ...
              child: PinCodeTextField(
                ...
                pinTheme: PinTheme(
                  ...
                  inactiveFillColor: Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()),
                  inactiveColor: Theme.of(context).primaryColor.withAlpha((0.2 * 255).round()),
                  activeColor: Theme.of(context).primaryColor.withAlpha((0.4 * 255).round()),
                  activeFillColor: Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()),
                ),
