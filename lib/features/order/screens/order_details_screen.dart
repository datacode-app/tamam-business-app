...
import 'package:tamam_business/common/widgets/input_dialog_widget.dart';
...
import 'package:tamam_business/features/order/screens/invoice_print_screen.dart';
import 'package:tamam_business/features/order/widgets/amount_input_dialogue_widget.dart';
import 'package:tamam_business/features/order/widgets/camera_button_sheet_widget.dart';
import 'package:tamam_business/features/order/widgets/cancellation_dialogue_widget.dart';
import 'package:tamam_business/features/order/widgets/collect_money_delivery_sheet_widget.dart';
import 'package:tamam_business/features/order/widgets/dialogue_image_widget.dart';
// import 'package:tamam_business/features/order/widgets/driver_assignment_widget.dart'; // TEMPORARILY DISABLED - Fleet Management
import 'package:tamam_business/features/order/widgets/order_item_widget.dart';
import 'package:tamam_business/features/order/widgets/slider_button_widget.dart';
import 'package:tamam_business/features/order/widgets/verify_delivery_sheet_widget.dart';
      ...
      child: Scaffold(
        appBar: CustomAppBarWidget(
          ...
          menuWidget: GetBuilder<OrderController>(builder: (orderController) {
            bool canAssignDriver = orderController.orderModel != null &&
                orderController.orderModel!.deliveryMan == null &&
                ['pending', 'confirmed', 'accepted'].contains(orderController.orderModel!.orderStatus);
            return canAssignDriver
                ? IconButton(
                    icon: const Icon(Icons.person_add_alt_1),
                    // Fleet management - temporarily disabled
                    onPressed: null, 
                    // Fleet management - temporarily disabled
                    /* () {
                      // This can be replaced with a direct call to a dialog
                      // For now, let's just log to console to show it works
                      print('Assign driver icon pressed for order ${widget.orderId}');
                      // Get.toNamed(RouteHelper.getSelectDeliveryManRoute(widget.orderId));
                    }, */
                  )
                : const SizedBox();
          }),
                          ...
                          child: SizedBox(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    // DriverAssignmentWidget(order: order),
                                                    ...
                                                    ? IconButton(
                                                        constraints:
                                                            const BoxConstraints(
                                                                maxHeight: 36),
                                                        onPressed: () {
                                                          // Small delay to help with focus after swipe gestures
