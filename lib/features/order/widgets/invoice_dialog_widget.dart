...
// Project imports:
import 'package:tamam_business/common/widgets/dotted_divider.dart';
...
import 'package:tamam_business/features/order/widgets/price_widget.dart';
...
class InvoiceDialogWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return OrientationBuilder(builder: (context, orientation) {
      double fixedSize = View.of(context).physicalSize.width /
            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Row(children: [
                  ...
                  Text(
                    DateConverter.dateTimeStringToMonthAndTime(
                        order!.createdAt!),
                    style: robotoRegular.copyWith(fontSize: fontSize - 2),
                    ...
                    if (orderDetails![index].variation!.isNotEmpty) {
                      if (orderDetails![index].variation!.isNotEmpty) {
                        List<String> variationTypes =
                            orderDetails![index].variation![0].type!.split('-');
                        if (variationTypes.length ==
                            orderDetails![index]
                                ...
                                .length) {
                          int index = 0;
                          for (var choice in orderDetails![index]
                              .itemDetails!
                              .choiceOptions!) {
                            variationText =
                ...
                PriceWidget(
                    ...
                    fontSize: fontSize),
                SizedBox(
                    height: (order!.additionalCharge != null &&
