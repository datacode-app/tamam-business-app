    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.start, children: [
          ...
          : Theme.of(context).textTheme.bodyLarge?.color?.withAlpha((0.7 * 255).round()))),

        ]),
      ),

      Divider(indent: 20, endIndent: 50, color: isSelect ? Theme.of(context).cardColor.withAlpha((0.2 * 255).round()) : Theme.of(context).disabledColor.withAlpha((0.3 * 255).round()), thickness: 1),
