      ...
      child: Stack(children: [
        ...
        Positioned(
          ...
          child: Column(children: [
            ...
            isCommission ? const SizedBox() : Divider(color: currentIndex != null ? Theme.of(context).cardColor.withAlpha((0.2 * 255).round()) : Theme.of(context).disabledColor.withAlpha((0.3 * 255).round()), indent: 70, endIndent: 70, thickness: 1),
            const SizedBox(height: Dimensions.paddingSizeDefault),

            isCommission ? Padding(
              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: Text(package.description ?? '', textAlign: TextAlign.center,
                  style: robotoRegular.copyWith(color: currentIndex != null ? Theme.of(context).cardColor.withAlpha((0.8 * 255).round()) : Theme.of(context).disabledColor.withAlpha((0.3 * 255).round())),
              ),
