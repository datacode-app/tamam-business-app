...
import 'package:tamam_business/features/business/widgets/payment_cart_widget.dart';
                          ...
                          return InkWell(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor.withAlpha((0.2 * 255).round()), width: 1),
                              ),
