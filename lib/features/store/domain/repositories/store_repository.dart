...
class StoreRepository implements StoreRepositoryInterface {
  ...
  @override
  Future<bool> updateStore(Store store, XFile? logo, XFile? cover, String min,
      String max, String type, List<Translation> translation) async {
    ...
    fields.addAll(<String, String>{
      ...
      'self_delivery_system': store.selfDeliverySystem.toString(),
      'fleet_assignment_mode': store.fleetAssignmentMode!,
      'preferred_driver_selection': store.preferredDriverSelection!,
    });
  ...
  Future<Response> addItem(
    ...
    if (Get.find<ProfileController>()
      ...
      fields.addAll(
          (<String, String>{'condition_id': item.conditionId!.toString()}));
    }
    ...
    if (Get.find<ProfileController>()
      ...
      fields.addAll(
          (<String, String>{'basic': item.isBasicMedicine!.toString()}));
    }
    if (Get.find<ProfileController>()
            .profileModel!
            .stores![0]
