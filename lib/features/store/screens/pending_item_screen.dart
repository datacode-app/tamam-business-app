...
import 'package:tamam_business/features/store/widgets/edit_button_widget.dart';
                      ...
                      itemBuilder: (context, index) => InkWell(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [BoxShadow(color: Theme.of(context).disabledColor.withAlpha((0.1 * 255).round()), spreadRadius: 1, blurRadius: 1, offset: const Offset(0, 0))],
                          ),
                          child: Padding(
                            ...
                            child: Row(children: [
                              ...
                              Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
                                    color: storeController.pendingItem![index].isRejected  == 0 ? Colors.blue.withAlpha((0.1 * 255).round()) : Theme.of(context).colorScheme.error.withAlpha((0.1 * 255).round()),
                                  ),
                                  child: Text(
