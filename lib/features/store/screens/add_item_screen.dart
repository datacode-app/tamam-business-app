...
import 'package:tamam_business/common/widgets/custom_time_picker_widget.dart';
...
import 'package:tamam_business/features/store/widgets/attribute_view_widget.dart';
import 'package:tamam_business/features/store/widgets/food_variation_view_widget.dart';
import 'package:tamam_business/helper/type_converter.dart';
...
class _AddItemScreenState extends State<AddItemScreen>
  ...
  void initState() {
    ...
    if (_update) {
      ...
      Get.find<StoreController>().setVeg(_item.veg == 1, false, null);
      ...
      Get.find<StoreController>().setVeg(false, false, null);
