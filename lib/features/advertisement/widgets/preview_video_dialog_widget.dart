                          ...
                          child: AspectRatio(
                            ...
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                border: Border.all(color: Theme.of(context).hintColor.withAlpha((0.2 * 255).round()))
                              ),
                              ...
                              Expanded(
                                child: InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Icon(Icons.arrow_forward_rounded, size: 20, color: Colors.white.withAlpha((0.8 * 255).round()),),
                                  ),
                                ),
                              )
                            ]),
