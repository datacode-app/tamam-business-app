...
import 'package:tamam_business/features/advertisement/widgets/ads_item.dart';
import 'package:tamam_business/features/advertisement/widgets/confirmation_bottom_sheet.dart';
import 'package:tamam_business/features/advertisement/widgets/network_video_preview_widget.dart';
                              ...
                              children: [
                                ...
                                AdsCard(
                                  ...
                                  subTitle: advertisementController
                                              ...
                                              ?.createdAt !=
                                          null
                                      ? DateConverter.dateToDateOnly(
                                          DateTime.parse(advertisementController
                                              .advertisementDetailsModel!
                                              .createdAt!))
                                      : '',
                                  mainAxisAlignment:
                                ...
                                AdsCard(
                                  ...
                                  title: 'duration'.tr,
                                  subTitle:
                                      '${DateConverter.dateToDateOnly(DateTime.parse(advertisementController.advertisementDetailsModel?.startDate ?? ""))} - ${DateConverter.dateToDateOnly(DateTime.parse(advertisementController.advertisementDetailsModel?.endDate ?? ""))}',
                                  mainAxisAlignment:
                                      MainAxisAlignment.spaceBetween,
                                ),
                                const SizedBox(
