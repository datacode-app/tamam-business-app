...
import 'package:tamam_business/common/widgets/custom_dropdown_widget.dart';
...
import 'package:tamam_business/features/advertisement/enums/ads_type.dart';
import 'package:tamam_business/features/advertisement/models/ads_details_model.dart';
import 'package:tamam_business/features/advertisement/widgets/create_advertisement_video_view_shimmer.dart';
import 'package:tamam_business/features/advertisement/widgets/custom_check_box.dart';
import 'package:tamam_business/features/advertisement/widgets/dotted_video_border.dart';
import 'package:tamam_business/features/advertisement/widgets/preview_profile_promotion_widget.dart';
import 'package:tamam_business/features/advertisement/widgets/preview_video_dialog_widget.dart';
...
class _CreateAdvertisementScreenState extends State<CreateAdvertisementScreen>
  ...
  void _editSetup() {
    ...
    validationController?.text =
        "${widget.adsDetailsModel?.startDate != null ? DateConverter.dateToDateOnly(DateTime.parse(widget.adsDetailsModel!.startDate!)) : ''} - ${widget.adsDetailsModel?.endDate != null ? DateConverter.dateToDateOnly(DateTime.parse(widget.adsDetailsModel!.endDate!)) : ''}";
    ...
    Get.find<AdvertisementController>().dateTimeRange = DateTimeRange(
      start: DateTime.parse(
          widget.adsDetailsModel?.startDate ?? DateTime.now().toString()),
      end: DateTime.parse(
          widget.adsDetailsModel?.endDate ?? DateTime.now().toString()),
    );
  }
  ...
  String modifyDateRange(DateTimeRange? dateTimeRange) {
    String firstDate = dateTimeRange != null
        ? DateConverter.dateToDateOnly(dateTimeRange.start)
        : '';
    String lastDate = dateTimeRange != null
        ? DateConverter.dateToDateOnly(dateTimeRange.end)
        : '';
