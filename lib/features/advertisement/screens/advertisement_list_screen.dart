...
import 'package:tamam_business/features/advertisement/widgets/empty_ads_view.dart';
                            ...
                            children: [
                              Expanded(
                                  child: Column(
                                      ...
                                      children: [
                                    Text(
                                      '${'ads_placed'.tr}: ${DateConverter.dateTimeStringToDateTime(advertisementList[index].createdAt!)}',
                                      style: robotoRegular.copyWith(
                                          fontSize: Dimensions.fontSizeSmall,
                                          color:
                                              Theme.of(context).disabledColor),
      ...
      child: Row(children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            color: isSelected
                ? Theme.of(context).primaryColor
                : Theme.of(context).disabledColor.withAlpha((0.3 * 255).round()),
          ),
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(Dimensions.radiusDefault),
                  color: isSelected
                      ? Theme.of(context).cardColor.withAlpha((0.2 * 255).round())
                      : Theme.of(context).cardColor.withAlpha((0.4 * 255).round()),
                ),
                child: Text(
                  adsCount.toString(),
                  maxLines: 1,
