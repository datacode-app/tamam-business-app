...
class Store {
  ...
  String? fleetAssignmentMode;
  String? preferredDriverSelection;
  ...
  Store({
    ...
    this.fleetAssignmentMode,
    this.preferredDriverSelection,
  });
  ...
  Store.fromJson(Map<String, dynamic> json) {
    ...
    fleetAssignmentMode = json['fleet_assignment_mode'];
    preferredDriverSelection = json['preferred_driver_selection'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['fleet_assignment_mode'] = fleetAssignmentMode;
    data['preferred_driver_selection'] = preferredDriverSelection;
    return data;
  }
}
