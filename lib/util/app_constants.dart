...
class AppConstants {
  static const String appName = 'Tamam for Business';
  ...
  static const int connectionTestTimeout = 10;
  static const int maxRetries = 1;

  static const bool appStoreReviewMode = false;

  static const String fontFamily = 'Roboto';
  static const String theme = 'sixam_mart_store_theme';
  static const double limitOfPickedVideoSizeInMB = 50;
  static const double maxSizeOfASingleFile = 10;

  static const String baseUrl = 'https://admin.tamam.shop';

  /// Get dynamic base URL from Remote Config
  /// Falls back to hardcoded baseUrl if Remote Config is not available
  static String get dynamicBaseUrl {
    try {
      return RemoteConfigHelper.getBackendBaseUrl();
    } catch (e) {
      return baseUrl; // Fallback to hardcoded URL
    }
  }

  /// Get developer-aware base URL (async version)
  /// This method checks for developer mode and returns appropriate URL
  static Future<String> getDeveloperAwareBaseUrl() async {
    try {
      return await DeveloperConfigHelper.getEffectiveBackendUrl();
    } catch (e) {
      return baseUrl; // Fallback to hardcoded URL
    }
  }
  ...
  static const String fleetDashboardUri = '/api/v1/vendor/fleet/dashboard';
  static const String getFleetAnalyticsUri = '/api/v1/vendor/fleet/analytics';
  static const String completedOrdersUri = '/api/v1/vendor/completed-orders';
  static const String cancelledOrdersUri = '/api/v1/vendor/canceled-orders';
  ...
  static const String deliveryManListUri = '/api/v1/vendor/delivery-man/list';
  static const String deliveryManScheduleUri =
      '/api/v1/vendor/fleet/drivers/schedule';
  static const String addDeliveryManUri = '/api/v1/vendor/delivery-man/store';
  static const String updateDeliveryManUri = '/api/v1/vendor/delivery-man/update';
  static const String deleteDeliveryManUri =
  ...
  static const String businessPlanUri = '/api/v1/vendor/business-plan';
  ...
  // Driver Assignment
  static const String getAvailableDriversUri = '/api/v1/vendor/delivery/orders';
  static const String assignDriverToOrderUri = '/api/v1/vendor/delivery/orders';

  //keys
  static const String serverKey =
      'AAAA6cZp18k:APA91bF2iP4gK3j8LgSnoPsYMEXp89nOD8oVv_6bHyh2Jhd31KNhDfT1Yq0L18n2c8yqLveD8y-52zR8gB1wB_a_1A8A2G4g7j9g5D3X4V6b9j8h7G5f4e3d2c1b0a9';
  static const String mapApiKey = 'AIzaSyBz4EV9tKSIv-JGVeOQl9-cFQzSISvxPEk';
}
