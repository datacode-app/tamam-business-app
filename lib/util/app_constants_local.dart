...
class AppConstants {
  static const String appName = 'Tamam for Business - Local Dev';
  ...
  // Temporary: point local dev to staging backend for debugging.
  // Remember to revert to emulator/local once done.
  static const String baseUrl = 'https://admin-stag.tamam.krd';
  ...
  static const String updateDeliveryManUri =
      '/api/v1/vendor/delivery-man/update';
  ...
  // Driver Assignment
  static const String getAvailableDriversUri =
      '/api/v1/vendor/orders/{order_id}/available-drivers';
  static const String assignDriverToOrderUri =
      '/api/v1/vendor/orders/{order_id}/assign-driver';
